package com.zero.dreamland.common.exception.handler;
 ...
 */
@Slf4j
@RestControllerAdvice("com.zero.dreamland")
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> badCredentialsException(BadCredentialsException e){
        // 打印堆栈信息
        String message = "坏的凭证".equals(e.getMessage())||"Bad credentials".equals(e.getMessage()) ? "用户名或密码不正确" : e.getMessage();
        log.error(message);
