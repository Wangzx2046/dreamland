<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开始提醒时间" prop="remindStartTime">
        <el-date-picker clearable size="small"
                        v-model="queryParams.remindStartTime"
                        type="date"
                        value-format="yyyy-MM-dd"
                        placeholder="选择开始提醒时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="结束提醒时间" prop="remindEndTime">
        <el-date-picker clearable size="small"
                        v-model="queryParams.remindEndTime"
                        type="date"
                        value-format="yyyy-MM-dd"
                        placeholder="选择结束提醒时间">
        </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="是否开启提醒" prop="isMessage">
        <el-input
          v-model="queryParams.isMessage"
          placeholder="请输入是否开启提醒"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="remindList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开始提醒时间" align="center" prop="remindStartTime" width="220">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.remindStartTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="结束提醒时间" align="center" prop="remindEndTime" width="220">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.remindEndTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="活动时间" align="center" prop="actTime" />
      <el-table-column label="活动链接" align="center" prop="actLink" />
      <el-table-column label="打卡状态" align="center" prop="signFlag" />
      <el-table-column label="打卡时间" align="center" prop="signTime" width="220">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否开启提醒" align="center" prop="isMessage" />
    ...
    <el-dialog title="详情" :visible.sync="xqopen" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="开始提醒时间：">{{form.remindStartTime }}</el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="结束提醒时间：">{{form.remindEndTime }}</el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="活动时间：">{{form.actTime }}</el-form-item>
          </el-col>
          <el-col :span="24">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="打卡状态" prop="signFlag">
          <el-input v-model="form.signFlag" placeholder="请输入打卡状态" />
        </el-form-item>
        <el-form-item label="打卡时间" prop="signTime">
          <el-date-picker clearable size="small"
        ...
        <el-form-item label="是否开启提醒" prop="isMessage">
          <el-input v-model="form.isMessage" placeholder="请输入是否开启提醒" />
        </el-form-item>
