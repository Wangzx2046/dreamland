 ...
 */
package com.zero.dreamland.quartz.config;
...
public class JobRunner implements ApplicationRunner {
    ...
    private final ISysQuartzJobService quartzJobRepository;
    ...
    public void run(ApplicationArguments applicationArguments) {
        log.info("--------------------注入定时任务---------------------");
        List<SysQuartzJob> quartzJobs = quartzJobRepository.findByIsPauseIsFalse();
