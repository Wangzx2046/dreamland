...
public class TableInfo {
    ...
    private String entityPropertyName;//首字母小写变量名
    private String mapperName;
    private String xmlName;
    private String serviceName;
    private String servicePropertyName;//首字母小写变量名
    ...
    public String getServicePropertyName() {
        return   this.serviceName.substring(1,2).toLowerCase()+ this.serviceName.substring(2);
    }
}
