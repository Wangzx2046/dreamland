...
public class GenTableColumnServiceImpl implements IGenTableColumnService
{
    ...
    @DS("#last")
    @Override
    public List<GenTableColumn> selectDbTableColumnsByName(String tableName,String dbName) {
        return genTableColumnMapper.selectDbTableColumnsByName(tableName);
    }

    @DS("#last")
    @Override
    public List<GenTableColumn> selectDbTableColumnsByNames(String[] tableNames, String dbName) {
        return genTableColumnMapper.selectDbTableColumnsByNames(tableNames);
    }
}