...
import com.zero.common.utils.CookieUtils;
...
import com.zero.framework.shiro.service.SysPasswordService;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", ZeroConfig.getCopyrightYear());
        mmap.put("demoEnabled", ZeroConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", ZeroConfig.getVersion());
        return "main";
    }
