...
public class FakerUtils {
    ...
    public static void main(String[] args) {
        ...
        accessDevices(RandomUtil.randomInt(200,220), "深圳市有方科技股份有限公司" , "共享雨伞" , "GXYS" , "MQTT" , "其他" , "低端" ,
                "工业品" , "广东省" , "深圳市" , "10" , ja);

        accessDevices(RandomUtil.randomInt(200,250), "深圳市有方科技股份有限公司" , "共享充电宝" , "GXCDB" , "MQTT" , "其他" , "低端" ,
                "工业品" , "广东省" , "深圳市" , "10" , ja);
    }
