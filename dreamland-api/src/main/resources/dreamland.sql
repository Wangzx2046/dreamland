...
CREATE TABLE `sys_dept`  (
  ...
  `del_flag` int(1) NOT NULL DEFAULT 0 COMMENT '状态标志：0正常 1禁用 2删除',
...
CREATE TABLE `sys_dict_detail`  (
  ...
  `del_flag` int(32) NOT NULL DEFAULT 0 COMMENT '状态标志：0正常 1禁用 2删除',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建者',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新者',
  `create_date` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_date` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `sys_role`  (
  ...
  `level` int(10) NULL DEFAULT 3 COMMENT '角色级别',
  `role_sort` int(11) NULL DEFAULT 0 COMMENT '排序',
...
CREATE TABLE `sys_user`  (
  ...
  `last_login_date` datetime(0) NULL DEFAULT NULL COMMENT '最后访问时间',
  ...
  `del_flag` int(1) NOT NULL DEFAULT 0 COMMENT '状态标志：0正常 1禁用 2删除',
  `create_date` datetime(0) NOT NULL COMMENT '插入时间',
