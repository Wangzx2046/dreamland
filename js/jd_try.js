...
let trialActivityIdSet = new Set()
...
let args_xh = {
     ...
     * 默认为 1 到 10
     * */
    tabId: process.env.JD_TRY_TABID && process.env.JD_TRY_TABID.split('@').map(Number) || [104,3,4,5,9,10,15,12,6,7,8,13,14,11,16],
    /*
    ...
    maxSupplyNum: process.env.JD_TRY_MAXSUPPLYNUM * 1 || 30,
    /*
...
function requireConfig() {
    return new Promise(resolve => {
        ...
        if (args_xh.env) {
            ...
            console.log(`maxSupplyNum: ${typeof args_xh.maxSupplyNum}, ${args_xh.maxSupplyNum}`)
                        ...
                        for (let item of data.data.feedList) {
                            ...
                            if (item.skuTitle && $.isPush) {
                                ...
                                if (args_xh.whiteList) {
                                    ...
                                    } else if (parseFloat(item.supplyNum) > args_xh.maxSupplyNum && item.supplyNum !== null) {
                                        args_xh.printLog ? console.log(`商品被过滤，提供申请的份数大于预设申请的份数 \n`) : ''
                                    ...
                                    } else if(trialActivityIdSet.has(item.trialActivityId)) {
                                        args_xh.printLog ? console.log(`商品被过滤,已经加入过了 ${tempKeyword}\n`) : ''
                                    } else {
